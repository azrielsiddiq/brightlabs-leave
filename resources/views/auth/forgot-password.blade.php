...
<head>
    ...
    <title>Lupa Kata Sandi - Brightlabs Leave</title>
...
<div class="login-container">
    ...
    <div class="login-card">
        <div class="text-center mb-4">
            <h1 class="fw-bold h4 mb-1">Lupa Kata Sandi?</h1>
            <p class="text-muted-custom">Tenang, kami akan bantu Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="btn-primary-modern mb-3">Kirim Tautan Reset</button>
